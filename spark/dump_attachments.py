...
# WIth ext regex catches the extension but need to fix the phonenumber call
# phonenum_candidate_regex_str = "([+]?[0-9]?[0-9]?[0-9- .()]{6,15}(/|x|ext)?[0-9]{1,4})"
phonenum_candidate_regex_str = "([+]?[0-9]?[0-9]?[0-9- .()]{6,15})[0-9]"
